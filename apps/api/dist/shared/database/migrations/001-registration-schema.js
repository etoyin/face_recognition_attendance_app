...
async function createFamiliesTable(queryInterface) {
...
async function createUnitsTable(queryInterface) {
    await queryInterface.sequelize.query(`
...
async function createChurchRolesTable(queryInterface) {
    await queryInterface.sequelize.query(`
...
async function createMembersTable(queryInterface) {
    await queryInterface.sequelize.query(`
...
async function createTemporaryMediaAssetsTable(queryInterface) {
    await queryInterface.sequelize.query(`
...
async function seedLookupTables(queryInterface) {
