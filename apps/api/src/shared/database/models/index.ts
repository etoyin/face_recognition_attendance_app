...
> {
  ...
  declare familyCode: string | null;
...
export class ChurchRole extends Model<
  InferAttributes<ChurchRole>,
  InferCreationAttributes<ChurchRole>
> {
  declare churchRoleId: string;
...
> {
  ...
  declare weddingAnniversary: string | null;
  declare dateJoinedChurch: string;
  declare waterBaptized: boolean;
  declare bornAgain: boolean;
  declare workerStatus: "WORKER" | "NON_WORKER";
  declare membershipStatus:
    | "ACTIVE"
    | "INACTIVE"
    | "NEW_MEMBER"
    | "TRANSFERRED";
  ...
  declare profilePhotoAssetId: string;
  declare registrationStatus: "COMPLETED";
...
export class TemporaryMediaAsset extends Model<
  InferAttributes<TemporaryMediaAsset>,
  InferCreationAttributes<TemporaryMediaAsset>
> {
  declare assetId: string;
  declare ownerUserId: string;
  declare memberId: string | null;
  declare assetType: "PROFILE_PHOTO" | "FACE_CAPTURE";
  ...
  declare capturePose:
    ...
    | "SLIGHT_RIGHT"
    | null;
  declare captureSequence: number | null;
  declare uploadStatus: "UPLOADED" | "COMMITTED" | "FAILED" | "EXPIRED";
