...
export type MemberRegistrationRequest = z.infer<
  typeof memberRegistrationRequestSchema
>;
...
} & MemberRegistrationRequest["personalInformation"] &
  MemberRegistrationRequest["membershipInformation"];
